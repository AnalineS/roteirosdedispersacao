...
const IntegratedTrackingContext = createContext<
  IntegratedTrackingContextType | undefined
>(undefined);
...
export const IntegratedTrackingProvider: React.FC<
  IntegratedTrackingProviderProps
> = ({ children, config = {}, userId }) => {
  ...
  }, [tracking.isInitialized, tracking.trackPageView, tracking]);
  ...
  }, [tracking.isInitialized, tracking.trackInteraction, tracking]);
...
export const useTrackingContext = (): IntegratedTrackingContextType => {
  ...
  if (!context && typeof window !== "undefined") {
    throw new Error(
      "useTrackingContext must be used within IntegratedTrackingProvider",
    );
  }
