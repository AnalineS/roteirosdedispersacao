...
def run_comprehensive_test():
    ...
    print("🧪 TESTE ABRANGENTE DO SISTEMA PREDITIVO")
    print("=" * 60)
    ...
    if success_rate >= 90:
        print("✅ Sistema preditivo funcionando corretamente!")
        return True
    elif success_rate >= 70:
        print("⚠️ Sistema preditivo com alguns problemas")
        return False
    else:
        print("❌ Sistema preditivo com problemas críticos")
        return False
