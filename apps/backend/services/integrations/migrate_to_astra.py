...
class AstraDBMigrator:
    ...
    def generate_migration_report(self) -> str:
        ...
        report = f"""
# [REPORT] Relatório de Migração Astra DB - Hanseníase RAG

**Data:** {end_time.strftime('%Y-%m-%d %H:%M:%S')}
**Duração:** {duration:.2f} segundos
**Status:** {'[OK] SUCESSO' if success_rate > 80 else '[WARNING] PARCIAL' if success_rate > 50 else '[ERROR] FALHA'}
...
## [SEARCH] Verificação de Integridade
...
**Fase:** 3.2 - Migração de dados para Astra DB
    ...
    def run_migration(self) -> bool:
        ...
        print("[START] FASE 3.2: Migração de Dados para Astra DB")
        print("=" * 60)
        ...
        try:
            ...
            if success:
                ...
                print("[OK] Dados migrados para Astra DB")
                print("[OK] Verificação de integridade passou")
                print("[START] Pronto para FASE 4.1: Análise preditiva")
            else:
                print("[YELLOW] MIGRAÇÃO CONCLUÍDA COM PROBLEMAS")
                print("[WARNING] Verifique o relatório para detalhes")
                print("[FIX] Correções podem ser necessárias")
