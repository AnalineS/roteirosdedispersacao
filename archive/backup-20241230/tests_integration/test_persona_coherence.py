...
{'🎉 **EXCELENTE** - Personas mantêm personalidade distinta e consistente' if results['success_rate'] >= 90 else '[OK] **BOA** - Personas funcionam com pequenos ajustes' if results['success_rate'] >= 80 else '[WARNING] **NECESSITA MELHORIAS** - Problemas significativos de coerência'}

---

## [SEARCH] Análise Detalhada por Persona
...
- [OK] Linguagem técnica apropriada: {'Consistente' if results['dr_gasnelio']['technical_language'] else 'Inconsistente'}
- [OK] Precisão científica: {'Adequada' if results['dr_gasnelio']['scientific_precision'] else 'Inadequada'}
- [OK] Evita linguagem casual: {'Sim' if results['dr_gasnelio']['avoids_casual'] else 'Não'}
- [OK] Identifica-se corretamente: {'Sim' if results['dr_gasnelio']['identifies_correctly'] else 'Não'}
...
**Características Validadas:**
- [OK] Linguagem empática: {'Consistente' if results['ga']['empathetic_language'] else 'Inconsistente'}
- [OK] Simplificação adequada: {'Apropriada' if results['ga']['adequate_simplification'] else 'Inapropriada'}
- [OK] Suporte emocional: {'Presente' if results['ga']['emotional_support'] else 'Ausente'}
- [OK] Identifica-se corretamente: {'Sim' if results['ga']['identifies_correctly'] else 'Não'}
...
**Dr. Gasnelio:** {'[OK] Se identifica corretamente' if results['identity']['gasnelio_identifies'] else '[ERROR] Problemas de identificação'}
**Gá:** {'[OK] Se identifica corretamente' if results['identity']['ga_identifies'] else '[ERROR] Problemas de identificação'}

---

## [TARGET] Métricas de Qualidade de Persona

### Critérios de Coerência:
{'[OK]' if results['technical_consistency'] >= 80 else '[ERROR]'} **Consistência Técnica (Dr. Gasnelio):** ≥ 80% (Atual: {results['technical_consistency']:.1f}%)
{'[OK]' if results['empathy_consistency'] >= 80 else '[ERROR]'} **Consistência Empática (Gá):** ≥ 80% (Atual: {results['empathy_consistency']:.1f}%)
{'[OK]' if results['differentiation_rate'] >= 70 else '[ERROR]'} **Taxa de Diferenciação:** ≥ 70% (Atual: {results['differentiation_rate']:.1f}%)
{'[OK]' if results['identity_consistency'] >= 90 else '[ERROR]'} **Consistência de Identidade:** ≥ 90% (Atual: {results['identity_consistency']:.1f}%)
...
## [NOTE] Conclusão sobre Coerência das Personas
