...
**Status:** {'✅ APROVADO' if results['overall_success'] else '❌ NECESSITA AJUSTES'}
...
{'🎉 **APROVADO** - Sistema adequado para testes com backend simplificado' if results['overall_success'] else '⚠️ **NECESSITA AJUSTES** - Melhorias identificadas para backend simplificado'}
...
**Dosagens Validadas:**
- Rifampicina adulto: {'✅' if results['protocols']['rifampicina_ok'] else '⚠️'}
- Clofazimina adulto: {'✅' if results['protocols']['clofazimina_ok'] else '⚠️'}
- Dapsona adulto: {'✅' if results['protocols']['dapsona_ok'] else '⚠️'}
...
{'✅ **Sistema Adequado** - Pode prosseguir para próxima fase com backend simplificado' if results['overall_success'] else '⚠️ **Ajustes Necessários** - Melhorar respostas mock do backend simplificado'}
